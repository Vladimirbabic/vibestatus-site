      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            {/* Social proof */}
            <div className="mt-6 flex items-center gap-4 text-sm text-text-muted justify-center lg:justify-start">
          ...
          <div className="flex-1 w-full max-w-xl lg:max-w-none">
            <div className="relative">
              <div className="bg-bg-card border border-border-subtle rounded-2xl overflow-hidden shadow-2xl aspect-video flex items-center justify-center">
                <div className="text-center p-8">
                  ...
                  <p className="text-text-muted text-sm">Video coming soon</p>
                </div>
              </div>
              {/* Decorative glow */}
